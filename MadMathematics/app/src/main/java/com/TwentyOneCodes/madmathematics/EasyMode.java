...
public class EasyMode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EasyQuestionGenerator generate = new EasyQuestionGenerator();
        ...
        theTimer = new CountDownTimer(90100, 1000){
            @Override
        ...
        OptionAssigner(options, String.valueOf(theAnswer));
    ...
    private void optionSelected(int option){
        ...
        EasyQuestionGenerator obj = new EasyQuestionGenerator();
        ...
        if(questionCounter <= 15) {
            if (questionCounter == 15) {
                ...
                OptionAssigner(obj.options, String.valueOf(obj.theAnswer));
            }
        }

    }

    private void OptionAssigner(ArrayList<Integer> options, String theAnswer){
        ...
        switch(theCorrectOption){
            case 1: optionA_Button.setText(theAnswer);
    ...
    private void openResultsPage(){
        ...
        dataBundle.putInt("TYPE_OF_QUESTIONS", 1);
